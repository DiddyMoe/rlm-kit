...
High-level map of the RLM fork. See docs/index/project_index.json, docs/index/trajectory_logging_coverage.md, docs/integration/ide_touchpoints.md.
...
- **clients/** — LM API integrations (OpenAI, Anthropic, Gemini, Portkey, LiteLLM, Azure, VsCodeLM, etc.).
- **environments/** — base_env, local_repl, docker_repl, modal_repl, prime_repl, daytona_repl.
- **logger/** — RLMLogger (JSONL), VerbosePrinter.
- **mcp_gateway/** — server, session, validation, provenance, tools (session, fs, span, chunk, search, exec, complete, provenance).
